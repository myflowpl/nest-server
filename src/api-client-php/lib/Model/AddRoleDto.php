 ...
 */
class AddRoleDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AddRoleDto';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getRoleNameAllowableValues();
        if (!is_null($this->container['role_name']) && !in_array($this->container['role_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'role_name', must be one of '%s'",
                $this->container['role_name'],
    ...
    public function setRoleName($role_name)
    {
        ...
        $allowedValues = $this->getRoleNameAllowableValues();
        if (!in_array($role_name, $allowedValues, true)) {
